# Change Map - Ticket Ownership Assignment
...
- Feature slug: `ticket-ownership-assignment`
...
- `specs/.devx/change-maps/ticket-ownership-assignment.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-ownership-assignment/specs.md`
- `specs/ticket-ownership-assignment/requirements.md`
- `specs/ticket-ownership-assignment/prompt.md`
