# Change Map - Ticket Lifecycle State Visibility
...
- Feature slug: `ticket-lifecycle-state-visibility`
...
- `specs/.devx/change-maps/ticket-lifecycle-state-visibility.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-lifecycle-state-visibility/specs.md`
- `specs/ticket-lifecycle-state-visibility/requirements.md`
- `specs/ticket-lifecycle-state-visibility/prompt.md`
