...
- `specs/.devx/change-maps/audit-history.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/audit-history/specs.md`
- `specs/audit-history/requirements.md`
- `specs/audit-history/tdd-tests.md`
- `specs/audit-history/prompt.md`
