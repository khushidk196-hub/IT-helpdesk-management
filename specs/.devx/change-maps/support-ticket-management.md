# Change Map - Ticket Management And Collaboration
...
- Feature slug: `support-ticket-management`
...
- `specs/.devx/change-maps/support-ticket-management.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/support-ticket-management/specs.md`
- `specs/support-ticket-management/requirements.md`
- `specs/support-ticket-management/tdd-tests.md`
- `specs/support-ticket-management/prompt.md`
