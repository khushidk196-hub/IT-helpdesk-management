...
- `specs/.devx/change-maps/ticket-viewing.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-viewing/specs.md`
- `specs/ticket-viewing/requirements.md`
- `specs/ticket-viewing/prompt.md`
