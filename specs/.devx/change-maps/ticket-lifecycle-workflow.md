# Change Map - Ticket Lifecycle Workflow
...
- Feature slug: `ticket-lifecycle-workflow`
...
- `specs/.devx/change-maps/ticket-lifecycle-workflow.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-lifecycle-workflow/specs.md`
- `specs/ticket-lifecycle-workflow/requirements.md`
- `specs/ticket-lifecycle-workflow/prompt.md`
