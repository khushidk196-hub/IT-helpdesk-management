# Change Map - Ticket Lifecycle Workflow Validation
...
- Feature slug: `ticket-lifecycle-validation`
...
- `specs/.devx/change-maps/ticket-lifecycle-validation.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-lifecycle-validation/specs.md`
- `specs/ticket-lifecycle-validation/requirements.md`
- `specs/ticket-lifecycle-validation/prompt.md`
