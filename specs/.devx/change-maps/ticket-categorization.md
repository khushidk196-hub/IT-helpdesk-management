# Change Map - Ticket Categorization
...
- Feature slug: `ticket-categorization`
...
- `specs/.devx/change-maps/ticket-categorization.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-categorization/specs.md`
- `specs/ticket-categorization/requirements.md`
- `specs/ticket-categorization/tdd-tests.md`
- `specs/ticket-categorization/prompt.md`
