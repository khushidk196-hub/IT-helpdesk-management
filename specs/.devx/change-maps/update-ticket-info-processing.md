# Change Map - Ticket Information Update During Processing
...
- Feature slug: `update-ticket-info-processing`
...
- `specs/.devx/change-maps/update-ticket-info-processing.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/update-ticket-info-processing/specs.md`
- `specs/update-ticket-info-processing/requirements.md`
- `specs/update-ticket-info-processing/tdd-tests.md`
- `specs/update-ticket-info-processing/prompt.md`
