# Change Map - Centralized IT Help Desk Platform
...
- Feature slug: `it-help-desk-tickets`
...
- `specs/.devx/change-maps/it-help-desk-tickets.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/it-help-desk-tickets/specs.md`
- `specs/it-help-desk-tickets/requirements.md`
- `specs/it-help-desk-tickets/tdd-tests.md`
- `specs/it-help-desk-tickets/prompt.md`
