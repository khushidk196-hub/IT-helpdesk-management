# Change Map - Ticket Work Management
...
- Feature slug: `it-support-ticket-management`
...
- `specs/.devx/change-maps/it-support-ticket-management.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/it-support-ticket-management/specs.md`
- `specs/it-support-ticket-management/requirements.md`
- `specs/it-support-ticket-management/tdd-tests.md`
- `specs/it-support-ticket-management/prompt.md`
