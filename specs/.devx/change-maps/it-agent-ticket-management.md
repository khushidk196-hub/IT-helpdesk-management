# Change Map - Ticket Assignment And Updates
...
- Feature slug: `it-agent-ticket-management`
...
- `specs/.devx/change-maps/it-agent-ticket-management.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/it-agent-ticket-management/specs.md`
- `specs/it-agent-ticket-management/requirements.md`
- `specs/it-agent-ticket-management/tdd-tests.md`
- `specs/it-agent-ticket-management/prompt.md`
