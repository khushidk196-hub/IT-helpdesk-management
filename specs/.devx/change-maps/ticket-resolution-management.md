# Change Map - Ticket Resolution Management
...
- Feature slug: `ticket-resolution-management`
...
- `specs/.devx/change-maps/ticket-resolution-management.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-resolution-management/specs.md`
- `specs/ticket-resolution-management/requirements.md`
- `specs/ticket-resolution-management/tdd-tests.md`
- `specs/ticket-resolution-management/prompt.md`
