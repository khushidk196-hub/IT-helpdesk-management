# Change Map - Ticket Detail Capture
...
- Feature slug: `ticket-detail-capture`
...
- `specs/.devx/change-maps/ticket-detail-capture.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-detail-capture/specs.md`
- `specs/ticket-detail-capture/requirements.md`
- `specs/ticket-detail-capture/tdd-tests.md`
- `specs/ticket-detail-capture/prompt.md`
