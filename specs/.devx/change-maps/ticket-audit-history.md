# Change Map - Ticket Audit History
...
- Feature slug: `ticket-audit-history`
...
- `specs/.devx/change-maps/ticket-audit-history.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-audit-history/specs.md`
- `specs/ticket-audit-history/requirements.md`
- `specs/ticket-audit-history/prompt.md`
