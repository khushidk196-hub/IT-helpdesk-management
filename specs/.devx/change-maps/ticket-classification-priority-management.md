# Change Map - Ticket Classification And Priority Management
...
- Feature slug: `ticket-classification-priority-management`
...
- `specs/.devx/change-maps/ticket-classification-priority-management.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-classification-priority-management/specs.md`
- `specs/ticket-classification-priority-management/requirements.md`
- `specs/ticket-classification-priority-management/tdd-tests.md`
- `specs/ticket-classification-priority-management/prompt.md`
