...
- Feature slug: `ticket-assignment`
...
- `specs/.devx/change-maps/ticket-assignment.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-assignment/specs.md`
- `specs/ticket-assignment/requirements.md`
- `specs/ticket-assignment/prompt.md`
