# Change Map - Ticket Categorization And Priority Management
...
- Feature slug: `ticket-categorization-priority-management`
...
- `specs/.devx/change-maps/ticket-categorization-priority-management.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-categorization-priority-management/specs.md`
- `specs/ticket-categorization-priority-management/requirements.md`
- `specs/ticket-categorization-priority-management/tdd-tests.md`
- `specs/ticket-categorization-priority-management/prompt.md`
