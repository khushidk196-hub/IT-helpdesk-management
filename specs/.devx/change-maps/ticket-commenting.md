...
- Feature slug: `ticket-commenting`
...
- `specs/.devx/change-maps/ticket-commenting.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-commenting/specs.md`
- `specs/ticket-commenting/requirements.md`
- `specs/ticket-commenting/prompt.md`
