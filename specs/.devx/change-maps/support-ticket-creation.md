# Change Map - Support Ticket Creation
...
- Feature slug: `support-ticket-creation`
...
- `specs/.devx/change-maps/support-ticket-creation.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/support-ticket-creation/specs.md`
- `specs/support-ticket-creation/requirements.md`
- `specs/support-ticket-creation/prompt.md`
