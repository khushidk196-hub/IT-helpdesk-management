# Change Map - Verifiable Critical Workflow Outcomes
...
- Feature slug: `verifiable-workflow-outcomes`
...
- `specs/.devx/change-maps/verifiable-workflow-outcomes.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/verifiable-workflow-outcomes/specs.md`
- `specs/verifiable-workflow-outcomes/requirements.md`
- `specs/verifiable-workflow-outcomes/prompt.md`
