# Change Map - Role-Based Access Control
...
- `specs/.devx/change-maps/role-based-access-control.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/role-based-access-control/specs.md`
- `specs/role-based-access-control/requirements.md`
- `specs/role-based-access-control/prompt.md`
