# Change Map - Agent Ticket Viewing
...
- Feature slug: `agent-ticket-viewing`
...
- `specs/.devx/change-maps/agent-ticket-viewing.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/agent-ticket-viewing/specs.md`
- `specs/agent-ticket-viewing/requirements.md`
- `specs/agent-ticket-viewing/prompt.md`
