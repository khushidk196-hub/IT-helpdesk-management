# Change Map - As an Employee, I want to receive notifications when my support ticket changes so that I stay informed about progress and required actions; As an IT Support Agent, I want to receive notifications when a support ticket is assigned or reassigned so that I can act on owned work without delay; As an IT Support Agent, I want ticket lifecycle events to trigger notifications so that stakeholders are informed of ticket activity (+83 more)
...
- Feature slug: `support-ticket-governance-suite`
...
- `specs/support-ticket-governance-suite/specs.md`
- `specs/support-ticket-governance-suite/requirements.md`
- `specs/support-ticket-governance-suite/prompt.md`
