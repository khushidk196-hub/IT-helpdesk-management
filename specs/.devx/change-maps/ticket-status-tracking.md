# Change Map - Ticket Status Tracking
...
- Feature slug: `ticket-status-tracking`
...
- `specs/.devx/change-maps/ticket-status-tracking.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/ticket-status-tracking/specs.md`
- `specs/ticket-status-tracking/requirements.md`
- `specs/ticket-status-tracking/prompt.md`
